  ...
  public class Methods{
    ...
    //test code
    public static void main(String[] arachnids){
      System.out.println(isDivisible(24,4));
      System.out.println(isDivisible(24,5));
      System.out.println(isDivisible(24,6));
      System.out.println(isDivisible(24,7));
      System.out.println(isDivisible(24,8));

      System.out.println(isTriangle(1,1,10));
      System.out.println(isTriangle(10,10,10));
      System.out.println(isTriangle(15,10,2));
  ...
  public static int ackermann(int m, int n){
    ...
    if(m==0) {
      ...
      if(n==0){
        ...
        return 0;  //should only happen once n becomes negative
      }
    
    } else {
      System.out.println("negative m!");
      return 0;  //should only happen once m becomes negative
    }
  }
}